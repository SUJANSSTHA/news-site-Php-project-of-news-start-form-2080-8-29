...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE category SET category_name = '{$cname}' WHERE category_id = {$category_id}";
    if (mysqli_query($conn, $sql)) {
        header("Location:{$hostname}/admin/category.php");
    } else {
        echo "<p style='color:red;text-align:center;margin:10px 0'>Failed to update category.</p>";
    }
}
